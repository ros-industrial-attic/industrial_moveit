...
public:
  ...
  /**
   * @brief This structure is to be used by all constraints to store specific
   * data
  ...
  struct ConstraintData {
    ...
    /**
     * @brief The constructure class which should be called by the inheriting
     * structure.
...
protected:
  ...
  bool
      debug_; /**< Provide control over if certain print statements are output
                 */
