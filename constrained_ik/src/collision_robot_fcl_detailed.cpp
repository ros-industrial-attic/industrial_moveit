...
namespace constrained_ik
{
  ...
  {
    return CollisionRobotFCLDetailed::distanceSelfDetailedHelper(req, res, state);
  }
  ...
  bool CollisionRobotFCLDetailed::getDistanceInfo(const DistanceMap &distance_detailed, DistanceInfoMap &distance_info_map)
  {
    Eigen::Affine3d tf;
    tf.setIdentity();
  ...
  bool CollisionRobotFCLDetailed::getDistanceInfo(const DistanceMap &distance_detailed, DistanceInfoMap &distance_info_map, const Eigen::Affine3d &tf)
  {
    bool status = true;
  ...
  void CollisionRobotFCLDetailed::DistanceRequest::enableGroup(const std::string group_name, const robot_model::RobotModelConstPtr &kmodel)
  {
