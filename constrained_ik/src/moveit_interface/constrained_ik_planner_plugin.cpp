...
namespace constrained_ik
{
  bool CLIKPlannerManager::initialize(const robot_model::RobotModelConstPtr &model, const std::string &ns)
  {
    ...
    planners_.insert(std::make_pair(JOINT_INTERP_PLANNER, CLIKPlanningContextPtr(new JointInterpolationPlanner(JOINT_INTERP_PLANNER, ""))) );
    planners_.insert(std::make_pair(CARTESIAN_PLANNER, CLIKPlanningContextPtr(new CartesianPlanner(CARTESIAN_PLANNER, ""))) );
