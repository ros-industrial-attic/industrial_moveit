...
/** @brief This is an example showing how to add a GoalToolOrientation
 * constraint using c++ */
int main(int argc, char *argv[]) {
  ros::init(argc, argv, "goal_tool_orientation_example");
  Constrained_IK ik;
  BasicKin kin;
  ...
  // Create constraint
  constraints::GoalToolOrientation *constraint =
      new constraints::GoalToolOrientation;
