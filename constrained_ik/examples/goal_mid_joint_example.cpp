...
/**  @brief This is an example showing how to add a GoalMidJoint constraint using c++ */
int main(int argc, char *argv[])
{
  ros::init(argc, argv, "goal_mid_joint_example");
  Constrained_IK ik;
  BasicKin kin;
  ...
  // Create constraint
  constraints::GoalMidJoint *constraint = new constraints::GoalMidJoint;
