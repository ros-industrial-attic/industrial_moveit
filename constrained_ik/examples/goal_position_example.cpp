...
/** @brief This is an example showing how to add a GoalPosition constraint using c++ */
int main(int argc, char *argv[])
{
  ros::init(argc, argv, "goal_position_example");
  Constrained_IK ik;
  BasicKin kin;
  ...
  // Create constraint
  constraints::GoalPosition *constraint = new constraints::GoalPosition;
