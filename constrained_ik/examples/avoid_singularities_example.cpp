...
/** @brief This is an example showing how to add a AvoidSingularities constraint
 * using c++ */
int main(int argc, char *argv[]) {
  ...
  // Create constraint
  constraints::AvoidSingularities *constraint =
      new constraints::AvoidSingularities;
