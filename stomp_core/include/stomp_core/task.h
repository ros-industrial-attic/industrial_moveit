...
typedef std::shared_ptr<Task>
    TaskPtr; /**< Defines a boost shared ptr for type Task */
...
public:
  ...
  /**
   * @brief computes the state costs as a function of the noisy parameters for
   * each time step.
   * @param parameters        A matrix [num_dimensions][num_parameters] of the
   ...
   * @param iteration_number  The current iteration count in the optimization
   * loop
   * @param rollout_number    The index of the noisy trajectory whose cost is
   * being evaluated.
  ...
  /**
   * @brief computes the state costs as a function of the optimized parameters
   * for each time step.
   * @param parameters        A matrix [num_dimensions][num_parameters] of the
   * policy parameters to execute
   * @param start_timestep    The start index into the 'parameters' array,
  ...
  /**
   * @brief Filters the given noisy parameters which is applied after noisy
   * trajectory generation. It could be used for clipping
   ...
   * @param parameters        The value of the parameters at the end of the
   * current iteration [num_dimensions x num_timesteps].
   */
   ...
   * @param parameters        The parameters generated at the end of the
   * optimization [num_dimensions x num_timesteps]
   */
