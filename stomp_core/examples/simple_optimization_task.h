...
public:
   ...
   * @param parameters        A matrix [num_dimensions][num_parameters] of the
   * current optimized parameters
   * @param start_timestep    The start index into the 'parameters' array,
   * usually 0.
   * @param num_timesteps     The number of elements to use from 'parameters'
   * starting from 'start_timestep'
   * @param iteration_number  The current iteration count in the optimization
   * loop
  ...
  /**
   * @brief computes the state costs as a function of the distance from the bias
   * parameters
   * @param parameters        A matrix [num_dimensions][num_parameters] of the
   * policy parameters to execute
   * @param start_timestep    The start index into the 'parameters' array,
   * usually 0.
   * @param num_timesteps     The number of elements to use from 'parameters'
   * starting from 'start_timestep'
  ...
  bool computeCosts(const Eigen::MatrixXd &parameters,
                    ...
                    int iteration_number, Eigen::VectorXd &costs,
  ...
  /**
   * @brief Filters the given parameters which is applied after the update. It
   * could be used for clipping of joint limits
...
protected:
  Eigen::MatrixXd parameters_bias_; /**< Parameter bias used for computing cost
                                       for the test */
